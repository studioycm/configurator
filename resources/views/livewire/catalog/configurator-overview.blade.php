<div class="grid grid-cols-[9fr_3fr] gap-6" x-data="{ savedDraft: JSON.stringify($wire.data) }" x-bind:data-draft-dirty="JSON.stringify($wire.data) !== savedDraft" x-on:catalog-overview-saved="savedDraft = JSON.stringify($wire.data)">
    <div class="space-y-5">
        {{ $this->form }}
