...
use Tests\Fixtures\Legacy\Casts\NormalizedIntArrayCast;
use Tests\Fixtures\Legacy\Database\Factories\OptionRuleFactory;
use Tests\Fixtures\Legacy\OptionRuleDependencyType;

#[UseFactory(OptionRuleFactory::class)]
