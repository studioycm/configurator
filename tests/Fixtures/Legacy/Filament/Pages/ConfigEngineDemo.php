...
namespace Tests\Fixtures\Legacy\Filament\Pages;
...
use Tests\Fixtures\Legacy\DTO\ConfigOptionDTO;
// use Filament\Infolists\Infolist;
use Tests\Fixtures\Legacy\DTO\ConfigStageDTO;
...
use Tests\Fixtures\Legacy\Services\ConfiguratorEngine;
...
class ConfigEngineDemo extends Page implements HasInfolists, HasSchemas
{
    ...
    protected string $view = 'legacy::filament.pages.config-engine-demo';
    ...
    public function viewImageAction(): Action
    {
        return Action::make('viewImage')
            ...
            ->modalContent(fn (array $arguments): View => view(
                'legacy::filament.pages.config-engine-demo.partials.modal-image',
                    ...
                    ->components([
                        TextEntry::make('mainImageUrl')
                            ...
                            ->state(function (?CatalogGroup $record): Htmlable|string {
                                ...
                                return $this->renderHtmlView('legacy::filament.pages.config-engine-demo.partials.image-trigger', [
                                    'url' => $url,
                                    'alt' => 'Main Image',
                    ...
                    ->components([
                        TextEntry::make('images')
                            ...
                            ->state(function (?ProductProfile $record): Htmlable|string {
                                ...
                                return $this->renderHtmlView('legacy::filament.pages.config-engine-demo.partials.image-grid', [
                                    'urls' => $urls,
                                ]);
                            }),
                    ]),
    ...
    {
        return view('legacy::filament.pages.config-engine-demo.partials.file-links', [
            'files' => $files,
